...
Tsakonian adjectives agree with the noun they modify in gender, number, and case. Once you understand the noun case system, adjectives follow naturally. Focus on the main paradigm types and take note of the consonant mutations that occur where a stem meets a suffix.
...
4. **Verb paradigm tables** — The large paradigm tables in [[5.2 Verbs]] classify verbs into conjugation types (PA1–PA15, PB1–PB3, etc.). Use them as a reference when you encounter an unfamiliar form. They do not need to be memorised.
