...
| **ΤΣ̑** | **τσ̑** | Laminal Dental Affricate | [t͡s̻] | — | tss | |
...
| Digraph | Translit. (García Chaparro, 2026a) | Notes |
| :--- | :--- | :--- |
| **μπ** | **b** (initial) / **mp** (mid) | |
| **ντ** | **d** (initial) / **nt** (mid) | |
| **γγ** | **ng** | |
