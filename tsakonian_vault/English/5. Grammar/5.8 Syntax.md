...
The rules for clitic pronoun placement vary between the subdialects and constitute one of the most theoretically interesting features of Tsakonian syntax. [[Tsakonian Studies State of the Art.md|(Liosis, 2017, p. 7)]]

### Propontis Tsakonian

In the Propontis subdialect, clitic pronouns are subject to the same restrictions that apply generally in medieval Greek (cf. Mackridge 1993, Condoravdi & Kiparsky 2004): if the verb is in initial position, the clitics follow it (**enclitic**); otherwise they precede the verb (**proclitic**). [[Tsakonian Studies State of the Art.md|(Liosis, 2017, p. 7)]]
...
In Peloponnesian Tsakonian, clitic pronouns are now **proclitic** in almost all syntactic environments. [[Tsakonian Studies State of the Art.md|(Liosis, 2017, p. 7)]]
...
When a clitic pronoun and the clitic auxiliary co-occur in the same verb phrase, the two clitics cluster together, and their relative position differs between the Peloponnesian and Propontis subdialects. [[Tsakonian Studies State of the Art.md|(Liosis, 2017, p. 7)]]
...
- **Periphrastic Genitive:** Possession is frequently expressed through prepositional phrases using _σε_ (to/in) or _από_ (from) followed by the accusative.
  - Example: _οι φίλοι σ’ εταγή τα γυναίκα_ (the friends of this woman) [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 236)]].
  - Example: _τα πόδια από των παιδιών_ (the feet of the children) [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 237)]].
- **Accusative for Possession:** The accusative case with the definite article often replaces the genitive form entirely.
  - Example: _τα πόδια της κότας_ (the chicken's legs) [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 236)]].
