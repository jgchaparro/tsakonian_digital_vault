...
El Diccionario Tsakonian Digital, lanzado en 2023, es el primer diccionario en línea para este idioma. Actualmente cuenta con unos 1.300 términos y admite traducciones bidireccionales entre tsakonio y griego, inglés y español. [[Tsakonian Digital Tsakonian’s journey towards Artificial Intelligence.md|(García Chaparro, 2025b)]]
...
El diccionario está construido con Python y el framework Django, diseñado para una fácil extensibilidad y mantenimiento. Utiliza la ortografía de Kostakis como estándar e incluye un script conversor automático para cambiar de ortografía sobre la marcha. [[Tsakonian Digital Tsakonian’s journey towards Artificial Intelligence.md|(García Chaparro, 2025b)]]
...
Se proporciona información gramatical siempre que está disponible: [[Tsakonian Digital Tsakonian’s journey towards Artificial Intelligence.md|(García Chaparro, 2025b)]]
...
Las características en desarrollo incluyen ejemplos de frases, marcado de uso dialectal, tablas de conjugación de verbos y ampliación de la sección de Gramática con tablas de paradigmas. [[Tsakonian Digital Tsakonian’s journey towards Artificial Intelligence.md|(García Chaparro, 2025b)]]

### Traductor Automático Neuronal (NMT)

El NMT de Tsakonian Digital es el primer modelo de traducción automática neuronal capaz de traducir entre tsakonio y griego en ambas direcciones. El modelo es de código abierto y está disponible en HuggingFace. [[Tsakonian Digital Tsakonian’s journey towards Artificial Intelligence.md|(García Chaparro, 2025b)]]
...
El corpus se divide en conjuntos de entrenamiento (80%), validación (10%) y prueba (10%). Cada par se desdobla en dos muestras (tsakonio→griego y griego→tsakonio) para admitir la traducción bidireccional. [[Tsakonian Digital Tsakonian’s journey towards Artificial Intelligence.md|(García Chaparro, 2025b)]]

Se derivaron dos conjuntos de datos de evaluación a partir del conjunto de prueba: [[Tsakonian Digital Tsakonian’s journey towards Artificial Intelligence.md|(García Chaparro, 2025b)]]
