...
El genitivo marca **posesión y relación** ('la cola del gato', 'la puerta de la casa'). Es el más reducido de los casos funcionales. El genitivo **plural** ha desaparecido casi por completo del tsakonio hablado. [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 235)]]
...
El genitivo plural se limita a unas pocas expresiones fijas de edad, cantidad o valor que se enumeran abajo [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, pp. 235-236)]]. En todos los demás casos, la posesión se expresa mediante construcciones alternativas.
...
Donde el genitivo ya no se usa, la posesión se expresa cada vez más mediante dos estrategias principales [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, pp. 236-237)]]:
...
Las variantes del artículo femenino resultan del **rotacismo** (el cambio fonético /s/ → /r/; véase [[2. Phonology]]). El comportamiento depende del sonido siguiente [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 220)]]:
...
Los sustantivos masculinos toman el artículo _ο / του / τον_ y terminan principalmente en **-α** (antigua 1.ª declinación) o en **-ε / -ο / -έ / -ό** (antigua 2.ª declinación). Sus clases de declinación se etiquetan **Α1–Α5** según [[Condensed Grammar of the Tsakonian Language in Tables.md|(García Chaparro, 2023, p. 4)]], sobre todo según la terminación de plural.

Los plurales masculinos establecen una distinción clave de **animacidad** —si el referente es animado o no— [[Tsakonian Studies State of the Art.md|(Liosis, 2017, p. 6)]]:
...
#### Paradigma Α1 — Terminación en -α, plural en -οι
...
#### Paradigma Α2 — tipo ο/ε (antigua 2.ª declinación)

El patrón masculino más productivo: nominativos en **-ο / -ό / -ε / -έ** con genitivo en **-ου / -ού** [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 226)]]. El plural es **-οι** para los animados y **-ου** para los inanimados. Un representante de cada subtipo:
...
#### Paradigma Α3 — Terminación en -α, plural en -ου
...
#### Paradigma Α4 — tipo en ε con plural -ούνε

Un grupo reducido de sustantivos terminados en **-ε** cuyo plural se forma añadiendo **-νε** a la raíz de genitivo en **-ου**, dando un plural en **-ούνε**. A diferencia de Α2, este plural no está condicionado por la animacidad: es léxicamente específico.

| Nominativo | Genitivo  | Plural  | Transliteración | Traducción |
| ---------- | --------- | ------- | --------------- | ----------- |
| ο άγιε     | του αγίου | αγίουνε | *o ágie, tou agíou, agíoune* | iglesia |

#### Paradigma Α5 — genitivo no flexionado, plural en -δε

Un conjunto de sustantivos cuyo genitivo es **idéntico al nominativo** (sin terminación de genitivo propia) y cuyo plural se forma añadiendo **-δε** directamente a la forma de nominativo. [[Condensed Grammar of the Tsakonian Language in Tables.md|(García Chaparro, 2023, p. 4)]]:
...
Un grupo reducido continúa la antigua 3.ª declinación o se aparta de otro modo de los paradigmas regulares. Sus genitivos se construyen sobre una raíz distinta de la del nominativo, lo que los hace irregulares [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 227)]].
...
**Genitivo en -έ (*-é*)** — el genitivo femenino secundario más común, posiblemente derivado del locativo del griego antiguo [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 229)]]:
...
| α τσ̑οίτα   | τα τσ̑οιτέ   | *a tssoíta, ta tssoité* | cama         |
| α σβάρνα   | τα σβαρνέ   | *a svárna, ta svarné* | grada      |
| α προβάτα  | τα προβατέ  | *a prováta, ta provaté* | oveja         |

**Genitivo en -ή (*-í*)** — un grupo más reducido procedente de la antigua 3.ª declinación [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, p. 230)]]:
...
Unos pocos sustantivos femeninos construyen su genitivo o plural sobre una raíz ampliada o alterada [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018, pp. 230-231)]]:
...
Los sustantivos neutros toman el artículo _το / του / το_ (el nominativo y el acusativo son siempre idénticos). Sus clases de declinación se etiquetan **Υ1–Υ5** según [[Condensed Grammar of the Tsakonian Language in Tables.md|(García Chaparro, 2023, p. 4)]], distinguidas sobre todo por la **terminación de plural**.
...
Varios neutros forman un plural impredecible sobre una raíz alterada [[Condensed Grammar of the Tsakonian Language in Tables.md|(García Chaparro, 2023, p. 4)]]:
