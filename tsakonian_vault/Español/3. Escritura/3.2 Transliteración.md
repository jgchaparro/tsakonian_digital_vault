...
| **ΤΣ̑** | **τσ̑** | Africada dental laminal | [t͡s̻] | — | tss | |
...
| Dígrafo | Translit. (García Chaparro, 2026a) | Notas |
| :--- | :--- | :--- |
| **μπ** | **b** (inicial) / **mp** (interior) | |
| **ντ** | **d** (inicial) / **nt** (interior) | |
| **γγ** | **ng** | |
| **γκ** | **gk** | |
| **αι** | **ai** | |
| **ει** | **ei** | |
