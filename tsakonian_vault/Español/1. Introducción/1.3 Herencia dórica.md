...
- **Rotacismo:** El *rotacismo* es el cambio de una consonante (aquí /s/) a /r/. El cambio de /s/ final a /r/ es un rasgo documentado del dórico laconio que permanece activo en la fonología del tsakonio [[Tsakonian Studies State of the Art.md|(Liosis, 2017)]]. Véase [[2. Phonology]] para ejemplos y más reglas.
