...
- **Periphrastic Genitive:** Possession is frequently expressed through prepositional phrases using *σε* (to/in) or *από* (from) followed by the accusative.
    - Example: *οι φίλοι σ’ εταγή τα γυναίκα* (the friends of this woman) [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018)]].
    - Example: *τα πόδια από των παιδιών* (the feet of the children) [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018)]].
- **Accusative for Possession:** The accusative case with the definite article often replaces the genitive form entirely.
    - Example: *τα πόδια της κότας* (the chicken's legs) [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018)]].
- **Synaloepha and Contraction:** Possessive constructions often feature phonological merging, such as the contraction of articles with the following noun.
    - Example: *τουρ αθρίποι* (of the people) where /s/ + /t/ + /r/ results in a merged form [[About the Genitive in Tsakonian Nouns.md|(Kisilier & Mertyris, 2018)]].
